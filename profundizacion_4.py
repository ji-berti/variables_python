...
nombre_completo_padre_1= input('Nombre y apellido de padre: ')

nombre_completo_padre_2= input('Nombre y apellido de madre: ')

nombre_hijo= input('Nombre del hijo: ')

nombre_1, apellido_1= nombre_completo_padre_1.split(' ')

nombre_2, apellido_2= nombre_completo_padre_2.split(' ')

nombre_completo_hijo= nombre_hijo.capitalize() + ' ' + apellido_1.capitalize() + ' ' + apellido_2.capitalize()

print(f'El nombre del hijo es: {nombre_completo_hijo}')